      ...
      {isOpen && (
        ...
        >
          ...
          <button
            ...
            className="flex w-full cursor-pointer items-center gap-2.5 rounded-lg px-2.5 py-2 text-left transition-colors hover:bg-slate-50 focus:bg-slate-50 disabled:cursor-not-allowed disabled:opacity-60"
            role="menuitem"
          >
            {isDownloading ? (
